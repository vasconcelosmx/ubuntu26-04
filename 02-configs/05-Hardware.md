...
#08_ Verificando a Temperatura do Servidor Ubuntu Server <br>
...
Entendendo os valores de saída das informações arquivo: __`os-release`__ 
...
Entendendo os valores de saída das informações do arquivo: __`lsb-release`__ 
...
**SAÍDA DO COMANDO UNAME:** Linux vasconcelos.pti.intra 6.8.0-57-generic #59-Ubuntu SMP PREEMPT_DYNAMIC Sat Mar 15 17:40:59 UTC 2025 x86_64 x86_64 x86_64 GNU/Linux
| ID | VALORES | INFORMAÇÃO|
|----|---------|-----------|
| 01 | Linux | Este é o nome do sistema operacional, que é o Linux |
| 02 | vasconcelos.pti.intra | Este é o hostname e FQDN da máquina |
...
**SAÍDA DA PRIMEIRA LINHA COMANDO MPSTAT:** Linux 6.8.0-57-generic (vasconcelos.pti.intra) 	10/05/2025 	_x86_64_	(2 CPU)
| ID | VALORES | INFORMAÇÃO|
|----|---------|-----------|
| 01 | Linux 6.8.0-57-generic (vasconcelos.pti.intra) | Versão do Kernel rodando no servidor |
...
**SAÍDA DA PRIMEIRA LINHA COMANDO IOSTAT:** Linux 6.8.0-57-generic (vasconcelos.pti.intra) 	10/05/2025 	_x86_64_	(2 CPU)
| ID | VALORES | INFORMAÇÃO|
|----|---------|-----------|
| 01 | Linux 6.8.0-57-generic (vasconcelos.pti.intra) | Versão do Kernel rodando no servidor |
| 02 | 10/05/2025 | Data atual do servidor |
...
**SAÍDA DA PRIMEIRA LINHA COMANDO SAR:** Linux 7.15.0-119-generic   (ctnvasconcelos)   20/06/2026   _x86_64_   (8 CPU)
| ID | VALORES | INFORMAÇÃO|
|----|---------|-----------|
| 01 | Linux 7.10.0-16-generic | Esta é a versão do kernel Linux que o sistema está rodando. |
| 02 | ctnvasconcelos | Este é o nome do host ou o nome da máquina. |
| 03 | 20/06/2026 | Data em que o comando foi executado, indicando quando as estatísticas foram coletadas. |
...
| ID | VALORES | INFORMAÇÃO|
|----|---------|-----------|
| 01 | 10:15:21 | O horário em que a amostra foi coletada. |
...
```bash
#analisando o desempenho do disco com o comando hdparm 
...
## 08_ Verificando a Temperatura do Servidor Ubuntu Server 
```bash
