...
| `inet 192.168.0.50`                                     | Endereço IPv4 atribuído à interface |
| `netmask 255.255.255.0`                                 | Máscara de sub-rede |
| `broadcast 192.168.0.255`                                | Endereço de broadcast IPv4 |
...
| **Gateway**     | `192.168.0.254` | Endereço IP do **gateway** usado para essa rota.                             |
...
| `ROUTER`         | `192.168.0.254`                           | Gateway padrão fornecido pelo servidor DHCP, usado para acessar redes externas.                         |
| `SERVER_ADDRESS` | `192.168.0.254`                           | Endereço IP do servidor DHCP que atendeu a requisição.                                                  |
| `NEXT_SERVER`    | `192.168.0.254`                           | Próximo servidor no processo DHCP (geralmente usado para boot PXE ou TFTP).                             |
...
| `DNS`            | `192.168.0.254`                           | Servidor(es) DNS fornecido(s) pelo DHCP.                                                                |
| `DOMAINNAME`     | `apto.intra`                             | Nome de domínio fornecido pelo servidor DHCP, usado para resolução DNS.                                 |
| `HOSTNAME`       | `wsvasconcelos`                             | Nome de host atribuído ao cliente (pode ser usado para identificação na rede).                          |
